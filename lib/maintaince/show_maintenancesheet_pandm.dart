...
class ShowMaintenanceSheetpandm extends StatelessWidget {
  var vehicleDetails;
  ShowMaintenanceSheetpandm(vehicleDetails) {
                                              ...
                                              image: NetworkImage(
                                                  '${RemoteServices
                                                      .baseUrlIMG}${photoList[selectedIndex]}')
                                                                            ...
                                                                            child:
                                                                                Image.network(RemoteServices.baseUrl + maintenanceController.vehicleMaintenanceDetail!.maintenanceReasonPhoto![maintenanceController.selectedIndex].reasonPhoto!, fit: BoxFit.contain),
                                                                          ),
                                                                        ),
                                                                        SizedBox(
                                                                            height:
                                                                              ...
                                                                              itemBuilder: (BuildContext context, int index) {
                                                                                return Container(
                                                                                    child: GestureDetector(
                                                                                        onTap: () {
                                                                                          setState(() {
                                                                                            maintenanceController.selectedIndex = index;
                                                                                          });

                                                                                          print('Here is selectedIndex ${maintenanceController.selectedIndex}');
...
/*                            Container(
                      ...
                      //     ? Container()
                      //     :maintenanceController.statusApprove==0 GestureDetector(
                      //         onTap: () async {
                      ...
                      //                     CustomLoadingPopup());
                      //             await maintenanceController.approveMaintaince(
                      //                 maintenanceController
